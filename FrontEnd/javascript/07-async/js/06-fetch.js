...
// Simulando un errore nell'endpoint riceviamo l'errore 404 in console, ma la Promise viene comunque risolta, perchè la fetch rifiuta la promise solo quando abbiamo un errore del network, ma troviamo nella response uno status di 404. Dobbiamo quindi ricorrere a un if per questi casi.
