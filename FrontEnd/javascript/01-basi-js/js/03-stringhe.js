...
//es1
let mioNome = "Gabriel";
console.log(mioNome.slice(1, nome.length));
...
for (let i = 0; i < arrayUp.length; i++) {
  arrayUp[i] = arrayUp[i].charAt(0).toUpperCase() + arrayUp[i].slice(1);
}
console.log(arrayUp.join(" "));

// correzione con Milo
let frase = "oggi sono a scuola";
